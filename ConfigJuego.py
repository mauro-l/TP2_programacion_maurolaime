...
def mostrar_config_juego(pantalla, eventos, datos_juego, fuente, fuente_game_over):
    ...
    pantalla.blit(
        fuente.render(
            f"Dificultad: {datos_juego['dificultad_seleccionada']}", True, NEGRO
        ),
        (50, 50),
    )
    pantalla.blit(
        fuente.render(
            f"Puntos por acierto: {DIFICULTADES[datos_juego['dificultad_seleccionada']]['puntos_aciertos']}",
            True,
            NEGRO,
        ),
        (50, 90),
    ...
    pantalla.blit(
        fuente.render(
            f"Puntos por error: {DIFICULTADES[datos_juego['dificultad_seleccionada']]['puntos_errores']}",
            True,
            NEGRO,
        ),
        (50, 130),
    ...
    pantalla.blit(
        fuente.render(
            f"Vidas: {DIFICULTADES[datos_juego['dificultad_seleccionada']]['vidas']}",
            True,
            NEGRO,
        ),
        (50, 170),
    ...
    pantalla.blit(
        fuente.render(
            f"Tiempo por pregunta: {DIFICULTADES[datos_juego['dificultad_seleccionada']]['tiempo_pregunta']}s",
            True,
            NEGRO,
        ),
        (50, 210),
